...
class NLContextManager():
    ...
    """
    lookup_table = json.load('lookup_table.json')

    def __init__(self):
        print("New NLContextManager for session")
    
    def check_pn_country(self, input):
        pass
    
    def check_pn_locale(self, input):
        pass

    def resolve_country_from_locale(self, input):
        pass
    
    def extract_lookup_hits(self, input):
        pass
